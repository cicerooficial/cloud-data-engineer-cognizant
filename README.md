<img align="center" src="https://hermes.digitalinnovation.one/assets/logos/dio-white.png" alt="Logo Semantix Inc." style="width: 35%" /><img align="center" src="https://hermes.digitalinnovation.one/tracks/9297b049-e054-408c-9a57-fbc3c3313505.png" alt="Logo Semantix Inc." style="width: 13%" />
...
- Bootcamp realizado em: Ago/2021 - Nov/2021
  ...
  <p align="center">
      <img src="http://img.shields.io/static/v1?label=STATUS&message=COMCLUÍDO&color=RED&style=for-the-badge"/>
...
- Aulas:
  - [Introdução ao Git e ao GitHub - 5 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#introdu%C3%A7%C3%A3o-ao-git-e-ao-github---5-horas)
  - [Linux: A introdução ao sistema operacional - 10 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#linux-a-introdu%C3%A7%C3%A3o-ao-sistema-operacional---10-horas)
  - [Shell script - Manipulando Arquivos - 2 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#shell-script---manipulando-arquivos---2-horas)
  - [Fundamentos de Arquitetura de Sistemas - 6 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#fundamentos-de-arquitetura-de-sistemas---6-horas)
  - [Arquitetura de Sistemas Avançado - 3 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#arquitetura-de-sistemas-avan%C3%A7ado---3-horas)
  - [Introdução a orquestração de contêineres com Docker - 4 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#introdu%C3%A7%C3%A3o-a-orquestra%C3%A7%C3%A3o-de-cont%C3%AAineres-com-docker---4-horas)
  - [Conceitos e melhores práticas com bancos de dados PostgreSQL - 9 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#conceitos-e-melhores-pr%C3%A1ticas-com-bancos-de-dados-postgresql---9-horas)
  - [Introdução ao MongoDB e Bancos de Dados NoSQL - 6 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#introdu%C3%A7%C3%A3o-ao-mongodb-e-bancos-de-dados-nosql---6-horas)
  - [Explorando o poder do NoSQL com Cassandra e HBase - 4 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#explorando-o-poder-do-nosql-com-cassandra-e-hbase---4-horas)
  - [Introdução à programação com Python - 8 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#introdu%C3%A7%C3%A3o-%C3%A0-programa%C3%A7%C3%A3o-com-python---8-horas)
  - [Fundamentos de ETL com Python - 5 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#fundamentos-de-etl-com-python---5-horas)
  - [Monitoramento de clusters Hadoop de alto nível com HDFS e YARN - 4 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#monitoramento-de-clusters-hadoop-de-alto-n%C3%ADvel-com-hdfs-e-yarn---4-horas)
  - [Orquestrando ambientes de Big Data distribuídos com Zookeeper, Yarn e Sqoop - 4 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#orquestrando-ambientes-de-big-data-distribu%C3%ADdos-com-zookeeper-yarn-e-sqoop---4-horas)
  - [Como realizar consultas de maneira simples no ambiente complexo de Big Data com Hive e Impala - 4 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#como-realizar-consultas-de-maneira-simples-no-ambiente-complexo-de-big-data-com-hive-e-impala---4-horas)
  - [Processando grandes conjuntos de dados de forma paralela e distribuída com Spark - 4 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#processando-grandes-conjuntos-de-dados-de-forma-paralela-e-distribu%C3%ADda-com-spark---4-horas)
  - [Criando pipelines de dados eficientes com Spark e Python - 4 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#criando-pipelines-de-dados-eficientes-com-spark-e-python---4-horas)
...
- Projetos:
  - [Análise de dados com Python e Pandas - 4 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#an%C3%A1lise-de-dados-com-python-e-pandas---4-horas)
  - [Criando um Ecossistema Hadoop Totalmente Gerenciado com Google Cloud Dataproc - 1 hora](https://github.com/cicerooficial/cloud-data-engineer-cognizant#criando-um-ecossistema-hadoop-totalmente-gerenciado-com-google-cloud-dataproc---1-hora)
  - [Criando seu Ecossistema de Big Data na Nuvem - 2 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant#criando-seu-ecossistema-de-big-data-na-nuvem---2-horas)
...
- ### ✅[Linux: A introdução ao sistema operacional - 10 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant/tree/main/aulas/1.%20Linux%20-%20Introducao-ao-sistema-operacional)
...
- ### ✅[Shell script - Manipulando Arquivos - 2 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant/tree/main/aulas/2.%20Shell%20script%20-%20Manipulando-Arquivos)
...
- ### ✅[Fundamentos de Arquitetura de Sistemas - 6 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant/tree/main/aulas/3.%20Fundamentos-de-Arquitetura-de-Sistemas)

  Aprenda nesse curso sobre como funcionam as arquiteturas de softwares, seus conceitos, aplicações e desenvolvimento de operações.

- ### ✅[Arquitetura de Sistemas Avançado - 3 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant/tree/main/aulas/4.%20Arquitetura-de-Sistemas-Avancados)

  Conheça sobre os conceitos da arquitetura de sistemas, aplicações em nuvem e operações em softwares.

- ### ✅[Introdução a orquestração de contêineres com Docker - 4 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant/tree/main/aulas/5.%20Introducao-ao-Docker)

  Nesse curso aprenderemos sobre o Docker, um projeto OpenSource que facilita a criação de ambientes isolados com container.

- ### ✅[Conceitos e melhores práticas com bancos de dados PostgreSQL - 9 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant/tree/main/aulas/6.%20Conceitos-e-melhores-praticas-com-bancos-de-dados-PostgreSQL)

  Esse curso ensinará como trabalhar com PostgreSQL, um gerenciador de banco de dados relacional.

- ### ✅[Introdução ao MongoDB e Bancos de Dados NoSQL - 6 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant/tree/main/aulas/7.%20Introduca-ao-MongoDB-e-Banco-de-Dados-NoSQL)
...
- ### ✅[Explorando o poder do NoSQL com Cassandra e HBase - 4 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant/tree/main/aulas/8.%20Explorando-o-poder-do-NoSQL-com-Cassandra-e-HBase)
...
- ### ✅[Introdução à programação com Python - 8 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant/tree/main/aulas/9.%20Introducao-a-programacao-com-Python)

  O curso trará todo o embasamento da linguagem Python, quando e onde é mais indicado aplicá-la.

- ### ✅[Fundamentos de ETL com Python - 5 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant/tree/main/aulas/10.%20Fundamentos-de-ETL-com-Python)
...
- ### ✅[Análise de dados com Python e Pandas - 4 horas](https://github.com/cicerooficial/cloud-data-engineer-cognizant/tree/main/projetos/1.%20Analise-de-dados-com-Python-e-Pandas)
